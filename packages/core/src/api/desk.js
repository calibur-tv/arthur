...
export const updateFolder = (ctx, { name, folder_id }) => ctx.post('v1/desk/folder/update', { name, folder_id })
...
export const moveFile = (ctx, { file_id, folder_id, name }) =>
  ctx.post('v1/desk/file/move', { file_id, folder_id, name })
