      ...
      <template #0>
        ...
        >
          <template #default="{ list }">
            <ul>
              <RecommendRectItem v-for="item in list" :key="item.id" :item="item" />
            </ul>
          </template>
        </HomepageFlow>
      </template>
...
<script>
import HomepageFlow from '@/components-new/HomepageFlow.vue'
import RecommendRectItem from '@/components-new/RecommendRectItem.vue'
