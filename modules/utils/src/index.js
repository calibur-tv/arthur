...
export const isDev = isNode ? true : /localhost|127./.test(window.location.host)
...
export const randomStr = () => `${Date.now()}-${Math.random().toString(36).substring(3, 6)}`
...
export const shortenNumber = (num) => (num > 1000 ? `${Math.floor((num / 1000) * 10) / 10}k` : num)
